# nvim-treesitter-queries-systemverilog

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-systemverilog/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-systemverilog/actions/workflows/validate.yml)

Neovim tree-sitter queries for **systemverilog**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-systemverilog",
...
- [ ] Changes are scoped to `systemverilog` — do not include files for other languages
